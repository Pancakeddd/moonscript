...
local types = require("moonscriptplus.types")
...
local insert
insert = table.insert
local destructure = require("moonscriptplus.transform.destructure")
...
return Transformer({
  ...
  ["return"] = function(self, node)
    ...
    if ret_val_type == "chain" or ret_val_type == "comprehension" or ret_val_type == "tblcomprehension" then
      local Value = require("moonscriptplus.transform.value")
