...
import NameProxy, LocalName, is_name_proxy from require "moonscriptplus.transform.names"

import Run, transform_last_stm, implicitly_return, last_stm
  from require "moonscriptplus.transform.statements"

types = require "moonscriptplus.types"
...
destructure = require "moonscriptplus.transform.destructure"
...
Transformer {
  ...
  return: (node) =>
    ...
    if ret_val_type == "chain" or ret_val_type == "comprehension" or ret_val_type == "tblcomprehension"
      -- TODO: clean this up
      Value = require "moonscriptplus.transform.value"
  ...
  class: require "moonscriptplus.transform.class"
