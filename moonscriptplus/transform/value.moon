import Transformer from require "moonscriptplus.transform.transformer"
import build, ntype, smart_node from require "moonscriptplus.types"

import NameProxy from require "moonscriptplus.transform.names"
import Accumulator, default_accumulator from require "moonscriptplus.transform.accumulator"
import lua_keywords from require "moonscriptplus.data"

import Run, transform_last_stm, implicitly_return, chain_is_stub from require "moonscriptplus.transform.statements"
parse_str = require("moonscript.parse").string

import construct_comprehension from require "moonscriptplus.transform.comprehension"

import insert from table
import unpack, dump, dumpsimple from require "moonscriptplus.util"
-- Reverses table
reverse = (t) ->
  nt = {}
  for i = #t, 1, -1
  ...
  chain: (node) =>
    ...
    if @macros\is_macro node[2][2]
      ...
      builder_functions = {
        ...
        tostr: (x) ->
          rend = @line(x)\render(@lines!)\flatten!
          code = ""
          for f in *rend
            code ..= f
