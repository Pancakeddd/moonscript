...
dump = require "moonscriptplus.dump"
transform = require "moonscriptplus.transform"

import NameProxy, LocalName from require "moonscriptplus.transform.names"
import Set from require "moonscriptplus.data"
import ntype, value_can_be_statement from require "moonscriptplus.types"

statement_compilers = require "moonscriptplus.compile.statement"
value_compilers = require "moonscriptplus.compile.value"
...
Macros = require 'moonscriptplus.macro'
...
class Block
  ...
  value: (node, ...) =>
    ...
    if @statement_compilers[action] -- hack! replace or @statement_compiles[action] with something better. (because of macros)
      return @stm node, ...
...
-- mmmm
with data = require "moonscriptplus.data"
