...
import ntype from require "moonscriptplus.types"
import Space from require "moonscriptplus.parse.literals"
...
is_assignable = do
  ...
  (node) ->
    ...
    switch ntype node
      when "ref", "self", "value", "self_class", "table", "quoteinsert"
        true
      when "chain"
...
format_assign = do
  ...
  (lhs_exps, assign) ->
    ...
    switch t
      ...
      when "insert"
        {"insert", lhs_exps, unpack assign, 2}
      else
