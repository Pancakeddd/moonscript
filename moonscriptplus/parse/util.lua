...
local ntype
ntype = require("moonscriptplus.types").ntype
local Space
Space = require("moonscriptplus.parse.literals").Space
...
do
  ...
  is_assignable = function(node)
    ...
    if "ref" == _exp_0 or "self" == _exp_0 or "value" == _exp_0 or "self_class" == _exp_0 or "table" == _exp_0 or "quoteinsert" == _exp_0 then
      return true
