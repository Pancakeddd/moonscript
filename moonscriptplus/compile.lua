...
local dump = require("moonscriptplus.dump")
local transform = require("moonscriptplus.transform")
local NameProxy, LocalName
do
  local _obj_0 = require("moonscriptplus.transform.names")
  NameProxy, LocalName = _obj_0.NameProxy, _obj_0.LocalName
end
local Set
Set = require("moonscriptplus.data").Set
local ntype, value_can_be_statement
do
  local _obj_0 = require("moonscriptplus.types")
  ntype, value_can_be_statement = _obj_0.ntype, _obj_0.value_can_be_statement
end
local statement_compilers = require("moonscriptplus.compile.statement")
local value_compilers = require("moonscriptplus.compile.value")
local concat, insert
do
  local _obj_0 = table
...
local Macros = require('moonscriptplus.macro')
do
  local _class_0
  local _base_0 = {
...
do
  ...
  local _base_0 = {
    ...
    value = function(self, node, ...)
      ...
      if self.statement_compilers[action] then
...
do
  local data = require("moonscriptplus.data")
