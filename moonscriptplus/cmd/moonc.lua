...
local split
split = require("moonscriptplus.util").split
...
compile_file_text = function(text, opts)
  ...
  local parse = require("moonscriptplus.parse")
  local compile = require("moonscriptplus.compile")
  local parse_time
  ...
  if opts.show_posmap then
    local debug_posmap
    debug_posmap = require("moonscriptplus.util").debug_posmap
    print("Pos", "Lua", ">>", "Moon")
